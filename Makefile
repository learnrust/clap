...
examples: cargo-example
	...
	cargo build ${_FEATURES4} --example escaped-positional && ${_DEBUG4}/escaped-positional -h
	cargo build ${_FEATURES4} --example cargo-example-derive            && ${_DEBUG4}/cargo-example-derive	   -h   
	...
	cargo build ${_FEATURES4} --example 02_crate			&& ${_DEBUG4}/02_crate			   -h   
	cargo build ${_FEATURES4} --example 02_app_settings		&& ${_DEBUG4}/02_app_settings		   -h   
	cargo build ${_FEATURES4} --example 03_01_flag_bool		&& ${_DEBUG4}/03_01_flag_bool		   -h   
	cargo build ${_FEATURES4} --example 03_01_flag_count		&& ${_DEBUG4}/03_01_flag_count		   -h   
	cargo build ${_FEATURES4} --example 03_02_option		&& ${_DEBUG4}/03_02_option		   -h   
	cargo build ${_FEATURES4} --example 03_02_option_mult		&& ${_DEBUG4}/03_02_option_mult	   	   -h
	cargo build ${_FEATURES4} --example 03_03_positional		&& ${_DEBUG4}/03_03_positional		   -h   
	cargo build ${_FEATURES4} --example 03_03_positional_mult	&& ${_DEBUG4}/03_03_positional_mult	   -h   
	cargo build ${_FEATURES4} --example 03_04_subcommands		&& ${_DEBUG4}/03_04_subcommands	   	   -h
	cargo build ${_FEATURES4} --example 03_05_default_values	&& ${_DEBUG4}/03_05_default_values	   -h   
